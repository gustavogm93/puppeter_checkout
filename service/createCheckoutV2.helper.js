...
const generateHeadersCheckoutV2 = () => {
  try {
    const myHeaders = new fetch.Headers();
    myHeaders.append(
      "x-api-key",
      "Basic NjkwMDA4ZDUtNTlhMi00YzQ0LWE1ODktNmU0OWRiYTllMDE5OjEzZmNkNWQ1LTU4Y2QtNDQ4MC05MDdjLTQ1NDEwZTY5N2YwNw=="
    );
...
const generateBodyCheckoutV2 = (data) => {
  try {
...
module.exports = { generateBodyCheckoutV2, generateHeadersCheckoutV2 };
