...
function logStart(paymentType) {
  const spaces = " ".repeat(30);
  const spacesEnd = " ".repeat(42 - paymentType.length);
  const slash = "-".repeat(80);

  console.log(`[${slash}]`);
  console.log(`[${spaces}Running ${paymentType}${spacesEnd}]`);
}

module.exports = { logHeader, logStart };
